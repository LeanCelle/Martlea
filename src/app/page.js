    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.searchContainer}>
          <input type="text" placeholder="Buscar a tu mejor candidato..." className={styles.searchBar} />
                ...
                <div key={profile.id} className={styles.profilesIntoGrid}>
                  <div>
                    ...
                    <div className={styles.profileImageContainer}>
                      <FiUser size={60} color="#777" className={styles.profileIcon} />
                    </div>
      ...
      <div className={styles.graphicContainer}>
        <div className={styles.textGraphic}>
          ...
          <p>1️⃣ <b>Plataformas:</b> Conectamos talento y empresas a través de una plataforma innovadora que simplifica la búsqueda y el reclutamiento.<br></br><br></br>
            2️⃣ <b>Identificación:</b> Facilitamos la identificación del candidato ideal mediante un sistema eficiente que resalta habilidades y experiencia.<br></br><br></br>
            3️⃣ <b>Estrategia:</b> Optimizamos el proceso de contratación con una estrategia ágil y efectiva, adaptada a las necesidades del mercado.<br></br><br></br>
            4️⃣ <b>Oportunidades:</b> Abrimos las puertas a nuevas oportunidades, permitiendo que empresas y profesionales encuentren su mejor camino al éxito.</p>
        </div>
